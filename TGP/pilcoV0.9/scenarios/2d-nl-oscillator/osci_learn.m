%% pendulum_learn.m
% *Summary:* Script to learn a controller for the 2D non linear oscilator
%
...
% 1. Initialization
clear all; close all;
settings_osci;            % load scenario-specific settings
basename = 'osci_';       % filename used for saving data
