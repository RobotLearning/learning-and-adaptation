function [X, fX, i] = minimin(X, f, length, prnt, varargin)

% Minimize a differentiable multivariate function using conjugate gradients.
%
% Usage: [X, fX, i] = minimin(X, f, length, prnt, P1, P2, P3, ... )
% 
...
% prnt    if false, function evaluation/value will not be printed.
...
%
% Modified by : Okan Koc, 2013-02-20
%
...
if prnt, fprintf('%s %6i;  Value %4.6e\r', S, i, f0); end
